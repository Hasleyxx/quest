...
public class LabIndustrialChem {
	...
	public LabIndustrialChem(int patientID, int transactionID, int chemID, int pathID, int medID, int qualityID,
			String fBS, String fBScon, String bUA, String bUAcon, String cREA, String cREAcon, String cHOL,
			String cHOLcon, String tRIG, String tRIGcon, String hDL, String hDLcon, String lDL, String lDLcon,
			String cH, String vLDL, String na, String k, String cl, String aLT, String aST, String hB, String aLP,
			String pSA, String rBS, String rBScon, String gGTP, String lDH, String calcium, String amylase,
			String lipase, String inPhos, String protein, String albumin, String globulin, String magnesium,
			String oGTT1, String oGTT1con, String oGTT2, String oGTT2con, String oGCT, String oGCTcon, String cPKMB,
			String cPKMM, String totalCPK, String ionCalcium, String bILTotal, String bILDirect, String bILIndirect,
